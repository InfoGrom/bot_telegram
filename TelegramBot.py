    ...
    try:
      ...
      if len(userdata) <= 0:
        self.database.query(
          ...
          commit=True)
        self.database.query(
          f"INSERT INTO settings (userid, balance, lang, tokens) VALUES('{userid}', {balance}, '{lang}', {tokens})",
          commit=True)
        return True
      return False
    except:
